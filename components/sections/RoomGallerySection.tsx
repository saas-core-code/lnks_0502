...
export default function RoomGallerySection() {
  ...
  const galleryItems = [
    {
      src: "/images/room-gallery/carousel/workScene__img_top4.webp",
      alt: "ワークスペース - デスクエリア",
      width: 224,
      height: 144
    },
    {
      src: "/images/room-gallery/carousel/workScene__img_top6.webp",
      alt: "ワークスペース - ミーティングエリア",
      width: 224,
      height: 144
    },
    {
      src: "/images/room-gallery/carousel/workScene__img_bottom3.webp",
      alt: "ワークスペース - 休憩スペース",
      width: 224,
      height: 144
    },
    {
      src: "/images/room-gallery/carousel/workScene__img_bottom4.webp",
      alt: "ワークスペース - 共同作業エリア",
      width: 224,
      height: 144
    },
    {
      src: "/images/room-gallery/carousel/workScene__img_bottom5.webp",
      alt: "ワークスペース - カフェスペース",
      width: 224,
      height: 144
    },
    {
      src: "/images/room-gallery/carousel/workScene__img_bottom6.webp",
      alt: "ワークスペース - プライベートブース",
      width: 224,
      height: 144
    },
  ];
      ...
      >
        <figure>
          <Image
            ...
            loading="eager"
          />
          <figcaption className="sr-only">当施設の作業環境の全景です。明るく快適な空間で生産性を高めることができます。</figcaption>
        </figure>
      </div>
